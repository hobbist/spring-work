...
public class User implements Serializable {
	private static final long serialVersionUID = -5599836633386743247L;
	...
	@Pattern(regexp = "^\\w{8,}$",message="Username can contain only numbers,letters, underscore",groups={PersistenceValidationGroup.class,FormValidationGroup.class})
	@Id
	@Column(name="username")
	private String username;
	@NotBlank(groups={PersistenceValidationGroup.class,FormValidationGroup.class})
	@Pattern(regexp="^\\S+$",groups={PersistenceValidationGroup.class,FormValidationGroup.class})
	@Size(min=8,max=15,message="password must be between 8 to 15 characters",groups={FormValidationGroup.class})
	@Column(name="password")
	private String password;
	@ValidateEmailAddress(message="email is not valid",groups={PersistenceValidationGroup.class,FormValidationGroup.class})
